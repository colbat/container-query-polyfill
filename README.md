...
**This is a fork of [GoogleChromeLabs/container-query-polyfill](https://github.com/GoogleChromeLabs/container-query-polyfill) to support iOS Safari versions below 14.5.**
